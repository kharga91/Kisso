...
import { ItemCounter } from '@/Component/sidebar/page'
 ...
 const userDetails = useSelector(state=>state.user)
  return (
    ...
    <div className='flex text-2xl m-6 p-2'>
      Hi 
       <div className='font-mono font-extrabold mx-4 text-green-400'>{userDetails}</div>
       {!userDetails && <p className='p-2 bg-orange-100 ml-2 rounded-lg text-sm'> ⚠️ User KYC is not verified. <Link href="/user-kyc">Verify Now</Link> </p> }
    ...
    <Card className='p-4'>
      <CardBody className='font-mono '>
       <div> 
        ...
        <div className=' text-4xl font-extrabold text-green-500'> {userDetails}</div>
        </div>
      </CardBody>
    </Card>
    </div>
