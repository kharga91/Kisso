...
const {userDetails} =  useSelector(state=>state.user)
  ...
  return (
    <Listbox
      ...
      className={`p-0 gap-0 divide-y divide-default-300/50 dark:divide-default-100/80 ${userDetails.role=='admin' ?'bg-blue-500': 'bg-green-500' }  max-w-[600px] text-red-500 overflow-visible shadow-small rounded-medium m-2`}
      itemClasses={{
    ...
    >
     ...
     {JSON.stringify(sideBarItems[userDetails.role])} {userDetails.role}
